	...
	<div class="row" style="background-color: #999999;">
		<div class="container"><br>	
				...
				<div class="well container-fluid">	
					<div class="panel-group col-lg-4 col-md-4 col-sm-4 col-xs-4" id="friendsbox">
						<div class="panel panel-dafault" style="border: 1px  solid #cccccc;">
							...
							<div class="panel-body">
								<?php
									...
									if(isset($_GET['currentUserMessaging']))
										$_SESSION['currentUserMessaging'] = $_GET['currentUserMessaging'];
									$buddies = getUsersImConversingWith($_SESSION['user_id']);
					...
					<?php
						...
						if(isset($_SESSION['currentUserMessaging']))
						{
