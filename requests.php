			...
			<div class="panel-group col-lg-12 col-md-12 col-sm-12 col-xs-12" id="friendsbox">
				<div class="panel panel-dafault" style="border: 1px  solid #cccccc;">
					<div class="panel-heading" style="background-color: #cccccc;">
						<center><h4>My Requests</h4></center>
					</div>
						...
						<table class="table" style="width: 80%; margin: auto;">	
							<tbody>
								<?php
									...
									$requests = getRequests($_SESSION['user_id'],'ASC', 100);
									...
									if(!empty($requests))
									{
										...
										{		
											...
											$image = getImage($requests[$key]['userIDSend']);
											$name = getName($requests[$key]['userIDSend']);
											...
											"		
												<tr>	
													<td style='line-height: 50px;'>										
														...
														<span><b style='font-size: 18px;'>".$name[0]." ".$name[1]."</b></span>								
													</td>	

													<td style='vertical-align: middle;'>																					
														<form method='POST' action='answerrequest.php'  style='display:inline;'>
															<button type='submit' name='submit' class='btn btn-md'>
																<input type='hidden' name='userrequestID' value=".$requests[$key]['userIDSend'].">
														...
														<form method='POST' action='answerrequest.php'  style='display:inline;'>
															<button type='submit' name='submit' class='btn btn-md'>
																...
																<i class='fa fa-user-times' aria-hidden='true'></i> Decline
															</button>		
														</form>									
													</td>
												</tr>	
										...
										echo "<tr><td><center><br>(No Requests)<br><br></td></tr>";	
